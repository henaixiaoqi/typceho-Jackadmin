...
<head>
  ...
  <meta itemprop="image" content="https://blogs.vca-inc.net.cn/images/500.png" />
  <meta name="description" itemprop="description" content="账号：admin \r\n 密码：password" />
  <meta name="viewport" content="width=device-width">
  <meta name="author" content="Jack'Blog" />
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>用Jack'Blog登录</title>
  <!-- Bootstrap 核心 CSS 文件 -->
  <link rel="stylesheet" href="//cdn.bootcss.com/bootstrap/3.3.5/css/bootstrap.min.css">
<style>
  <!-- 以下链接为随机图片api，改动后将不再显示登录界面背景 -->
    body{background:url('https://blogs.vca-inc.net.cn/api/api.php');background-repeat:no-repeat;background-attachment:fixed;overflow:hidden;}
    /*web background*/
    .container{
      display:table;
      height:100%;
